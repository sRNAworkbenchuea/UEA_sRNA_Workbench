 ...
 */
package uk.ac.uea.cmp.srnaworkbench.tools.defaulttoolFX;
 ...
 * @author w0445959
 */
public class DefaultToolSceneController implements Initializable, ControlledScreen
{
    ...
    public DefaultToolSceneController(Rectangle2D visualBounds, DefaultToolWorkflowModule parent)
    {
        myParent = parent;
    ...
    {
        assert mainAnchorPane != null : "fx:id=\"mainAnchorPane\" was not injected: check your FXML file 'DefaultToolScene.fxml'.";

        assert mainWebView != null : "fx:id=\"mainWebView\" was not injected: check your FXML file 'DefaultToolScene.fxml'.";
    ...
    public class DefaultToolJSReceiver extends JavascriptBridge
    {
        private File lastFileDir = null;

        public DefaultToolJSReceiver(ScreensController controller)
        {
            super(controller);
        }
