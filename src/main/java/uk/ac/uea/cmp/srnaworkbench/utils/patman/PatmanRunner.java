...
/**
 * A helpful wrapper class that manages calls to the patman tool (Prufer et al. 2008.  
 * Patman: rapid alignment of short sequences to large databases. Bioinformatics, 
 * 24(13), 1530-1531).
 * @author Dan Mapleson
 */
public class PatmanRunner extends RunnableTool
{
  ...
  /**
   * Creates a new PatmanRunner with all the details necessary to start the binary.
   * This constructor variant is intended for use by tools running at the command
   * line or when GUI progress statistics are not required.
   * @param input The short read file
   * @param database The long read file
   * @param output The file to which matches will be written
   * @param temp_dir The directly to which any temporary files will be written.
  ...
  /**
   * Creates a new PatmanRunner with all the details necessary to start the binary.
   * This constructor variant is intended for use by tools running on the GUI 
   * where progress statistics can be tracked using a {@link StatusTracker} object
   * containing progress bar and a status label.
   * @param input The short read file
   * @param database The long read file
   * @param output The file to which matches will be written
   * @param temp_dir The directly to which any temporary files will be written.
