...
//      logFinish( this, null );
    ...
    RNAPLEX {
        ...
        public String run(String[] args) throws Exception {
            ...
            // launch EXE and grab stdin/stdout and stderr
            String filePath = getToolPath("RNAplex");

            logStart(this, filePath);

            Process process = JAVA_RUNTIME.exec(filePath);
            ProcessStreamManager psm = new ProcessStreamManager(process, "RNAPLEX", false);
...
//      logFinish( this, null );
    ...
    DUSTMASKER {
        ...
        public String run(String[] args) throws Exception {
            ...
            // launch EXE and grab stdin/stdout and stderr
            String filePath = getToolPath("dustmasker");
            ...
            ProcessStreamManager psm = new ProcessStreamManager(process, "DUSTMASKER", true);
            int code = psm.runInForeground(false);
