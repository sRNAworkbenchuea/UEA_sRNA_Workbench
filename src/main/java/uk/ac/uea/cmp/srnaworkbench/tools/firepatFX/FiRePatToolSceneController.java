 ...
 */
package uk.ac.uea.cmp.srnaworkbench.tools.firepatFX;
 ...
 * @author Josh Thody
 */
public class FiRePatToolSceneController implements Initializable, ControlledScreen
{
    ...
    private FiRePatToolJSReceiver myJSBridge;
    
    
    
    private final FiRePatToolWorkflowModule myParent;
    private final Rectangle2D visualBounds;
    
    public FiRePatToolSceneController(Rectangle2D visualBounds, FiRePatToolWorkflowModule parent)
    {
        myParent = parent;
    ...
    {
        assert mainAnchorPane != null : "fx:id=\"mainAnchorPane\" was not injected: check your FXML file 'FiRePatScene.fxml'.";

        assert mainWebView != null : "fx:id=\"mainWebView\" was not injected: check your FXML file 'FiRePatScene.fxml'.";
        
        mainWebEngine = mainWebView.getEngine();

        myJSBridge = new FiRePatToolJSReceiver(this.myController);
        ...
        mainWebEngine.setOnAlert((WebEvent<String> arg0) -> {
            System.out.println("FiRePat Event: " + arg0);
        });
    ...
    private void refreshMainView()
    {
        try
        {
            ...
            final URL h_view = new URL("file:" + Tools.WEB_SCRIPTS_DIR + "/HTML/FiRePatView.html");
    ...
    public class FiRePatToolJSReceiver extends JavascriptBridge
    {
        private File lastFileDir = null;

        public FiRePatToolJSReceiver(ScreensController controller)
        {
            super(controller);
        }
