 ...
 * @author M.B Stocks
 */
public class FastaDecoder implements Decoder<byte[][]> {
  ...
  {
    File file = new File("/Developer/Applications/sRNAWorkbench/TestingData/AtH/Arabidopsis_with_replicates/GSM154336_carrington_col0_flower_nr/GSM118373_Rajagopalan_col0_leaf_nr.fa");
