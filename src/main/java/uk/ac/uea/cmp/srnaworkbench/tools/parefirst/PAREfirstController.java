 ...
 */
public class PAREfirstController extends Controller implements ControlledScreen {

    private PAREfirstModule module;
    @FXML
    private WebView mainWebView;
    private JavaApplication javaApp;

    public PAREfirstController(PAREfirstModule module) {
        this.module = module;
    }

    @Override
    protected void initWebFile() {
        setWebFile(IOUtils.DIR_SEPARATOR + "HTML" + IOUtils.DIR_SEPARATOR + "PAREfirst.html");
    }

    @Override
    protected void initJSClass() {
        this.javaApp = new PAREfirstController.JavaApplication();
    ...
    public void setModule(PAREfirstModule module) {
        this.module = module;
    }
    ...
    public void updateUI() {
        try {
            ...
            Logger.getLogger(PAREfirstController.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(PAREfirstController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public class JavaApplication {
        ...
        public void showTPlot() {
            File file = new File(PAREfirstModule.GUI_DIR.getAbsolutePath() + DIR_SEPARATOR + transcriptID + "_" + predictorID + "_tplot.json");
            if (file.exists()) {
        ...
        public void setSelectedHairpin(String dataRow) {
            ...
            if (module.isComplete()) {
                String hpID = PAREfirstModule.GUI_DIR.getAbsolutePath() + DIR_SEPARATOR + "hp_" + predictionID + ".xrna";
